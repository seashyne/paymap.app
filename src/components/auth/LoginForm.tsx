...
const COPY = {
  en: {
    ...
    workspaceHint: "Sign in to open your ERP Lite workspace for invoices, stock, sales, cashflow, and reports.",
    signIn: "Log in",
    or: "Or",
  ...
  th: {
    ...
    workspaceHint: "เข้าสู่ระบบเพื่อเปิด ERP Lite workspace สำหรับ invoice, stock, sales, cashflow และรายงาน",
    signIn: "เข้าสู่ระบบ",
    or: "หรือ",
  ...
  lo: {
    ...
    workspaceHint: "ເຂົ້າລະບົບເພື່ອເປີດ ERP Lite workspace ສໍາລັບ invoice, stock, sales, cashflow ແລະ report.",
    signIn: "ເຂົ້າລະບົບ",
    or: "ຫຼື",

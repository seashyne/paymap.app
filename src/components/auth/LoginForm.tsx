...
const COPY = {
  en: {
    ...
    workspaceHint: "Sign in for Cloud Backup and account features. The Windows app remains local-first by default.",
    signIn: "Log in",
    or: "Or",
    google: "Continue with Google",
    apple: "Continue with Apple",
    success: "Logged in successfully. Opening your PayMap account.",
  ...
  th: {
    ...
    workspaceHint: "เข้าสู่ระบบสำหรับ Cloud Backup และบัญชี PayMap แอป Windows ยังเป็น local-first ตามค่าเริ่มต้น",
    signIn: "เข้าสู่ระบบ",
    or: "หรือ",
    google: "เข้าสู่ระบบด้วย Google",
    apple: "เข้าสู่ระบบด้วย Apple",
    success: "เข้าสู่ระบบสำเร็จ กำลังเปิดบัญชี PayMap",
  ...
  lo: {
    ...
    workspaceHint: "ເຂົ້າລະບົບສໍາລັບ Cloud Backup ແລະບັນຊີ PayMap. ແອັບ Windows ຍັງ local-first ເປັນຄ່າເລີ່ມຕົ້ນ.",
    signIn: "ເຂົ້າລະບົບ",
    or: "ຫຼື",
  ...
  zh: {
    ...
    workspaceHint: "默认情况下，你的财务数据保存在设备上。Cloud Backup 需要你主动开启。",
    signIn: "登录",
    or: "或",
    google: "使用 Google 登录",
    apple: "使用 Apple 登录",
  ...
  ja: {
    ...
    workspaceHint: "金融データはデフォルトで端末に保存されます。Cloud Backup は任意で有効化できます。",
    signIn: "ログイン",
    or: "または",
    google: "Google でログイン",
    apple: "Apple でログイン",
  ...
  ko: {
    ...
    workspaceHint: "금융 데이터는 기본적으로 기기에 저장됩니다. Cloud Backup은 직접 켤 때만 사용됩니다.",
    signIn: "로그인",
    or: "또는",
    google: "Google로 로그인",
    apple: "Apple로 로그인",
  ...
  vi: {
    ...
    workspaceHint: "Dữ liệu tài chính mặc định ở trên thiết bị. Cloud Backup chỉ bật khi bạn chọn.",
    signIn: "Đăng nhập",
    or: "Hoặc",
  ...
  es: {
    ...
    workspaceHint: "Tus datos financieros permanecen en tu dispositivo por defecto. Cloud Backup es opcional.",
  ...
  fr: {
    ...
    workspaceHint: "Vos données financières restent sur votre appareil par défaut. Cloud Backup est optionnel.",
    signIn: "Se connecter",
    or: "Ou",
  ...
  de: {
    ...
    workspaceHint: "Ihre Finanzdaten bleiben standardmäßig auf Ihrem Gerät. Cloud Backup ist optional.",
    signIn: "Anmelden",
    or: "Oder",
